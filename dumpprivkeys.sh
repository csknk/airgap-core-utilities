...
# Create a passphrase file - can be used as an offline-only keyfile
# ------------------------------------------------------------------------------
...
# Loop through the public addresses in the manifest, create encrypted files containing corresponding private
# keys. Securely delete intermediate plaintext copies of the private keys.
# ------------------------------------------------------------------------------
function dump_keys {
	...
	for PUB in $PUB_ADDRESSES; do
		...
		# Printable encrypted file for each private key
